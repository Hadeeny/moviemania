...
const Header = () => {
  ...
  return (
    <div className='flex fixed top-0 left-0 right-0 w-full py-8 px-2 bg-black/50 backdrop-blur-md justify-between items-center'>
      <Link href={'/'}>
        <h1 className='text-3xl text-green-500'>Movie<span className='text-cyan-700'>Mania</span></h1>
      </Link> 
      ...
      <Link className='bg-green-500 px-4 py-1 rounded' href={`/search/${query}`}>Search</Link>
      </div>
